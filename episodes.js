//In order to link the data to script.js and use this information there, we need to export each function, initialise npm and set the type:"module" in package.json, add type="module" to script tag in index.html, and import these two functions in this file inside the script file.
